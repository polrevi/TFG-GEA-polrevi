...
# Input: BOP2n_2022.csv, Variables_info.xlsx 
# Output: preprocessed_OPdata.xlsx, preprocessed_DEMOdata.xlsx, update_variablesinfo.xlsx
...
#####################################################
## (1) CARREGAR VARIABLES DE VERITAT (NO METADATA) ##
#####################################################
...
############################################
## (2) ARREGLAR FORMAT VARIABLES ORDINALS ##
############################################
...
###########################################################
## (3) CANVIAR VARIABLES NOMINALS ESPECIALS PER ORDINALS ##
###########################################################
...
## BLOC: SIT_ECO_CAT, SIT_ECO_ESP, SIT_POL_CAT, SIT_POL_ESP
...
###############################################
## (4) ESTUDI MISSINGS VARIABLES I INDIVIDUS ##
###############################################

##################################################
## DADES COMPLETES: (Demografia+Opinio publica) ##
##################################################
...
######################################
## ORDINAL_DATA: Variables ordinals ##
######################################
...
###################################################
## (5) BASE DE DADES OPINIO PUBLICA I DEMOGRAFIA ##
###################################################
