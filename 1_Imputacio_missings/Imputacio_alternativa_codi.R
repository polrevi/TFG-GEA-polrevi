...
# Input: preprocessed_OPdata, preprocessed_DEMOdata, update_variablesinfo.xlsx
# Output: ip_data_ordinal, ip_data_demo, index_ccomplet
...
# Hi ha nomes 3 variables amb missings: 
# SIT_LAB_ACTIU (9.45%), SECTOR (9.45%) i PERSONES_LLAR (0.53%)
